...
const books = [
  ...
  },
  {
    ...
    genre: "Dystopian",
    description: "A vision of a future society driven by technology and conformity."
  },
  {
    title: "The Hobbit",
...
mongoose.connect('mongodb+srv://vishnu:vishnu1421@book.xzccs.mongodb.net/?retryWrites=true&w=majority', { useNewUrlParser: true, useUnifiedTopology: true })
  .then(async () => {
